...
**카드 내용**:
- 버스 번호 (파란색 배지)
- 버스 타입 (저상버스만 초록색 배지 표시)
- 막차 여부 (🚨 아이콘)
- 방면 정보
- 첫 번째 버스 도착 시간 (파란색 강조)
- 두 번째 버스 도착 시간 (기본색)

**카드 스타일**:
- 프로토타입 디자인 기반
- HTML/CSS를 사용한 커스텀 디자인
- 흰색 배경, 둥근 테두리, 그림자 효과
- 반응형 그리드 레이아웃
...
**지도 설정**:
- 기본 줌 레벨: 15 (동네 수준)
- 마커 색상: 파란색 (RGBA: 0, 100, 255, 200)
- 마커 반지름: 15 (픽셀 고정: 8~12px)
- 스타일: road (Mapbox 도로 지도)
- 확대/축소 시 일정한 마커 크기 유지
